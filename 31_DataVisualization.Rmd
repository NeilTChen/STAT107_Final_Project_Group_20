...
ggsave("fg_distribution_histograms.png", width = 10, height = 6)
```
...
ggsave("paired_fg_boxplot.png", width = 8, height = 6)
```
...
ggsave("fg_correlation_scatter.png", width = 8, height = 6)
```
...
ggsave("team_fg_percent_boxplot.png", plot = plot_fg_boxplot, width = 7, height = 5)
```
...
ggsave("team_tp_percent_boxplot.png", plot = plot_tp_boxplot, width = 7, height = 5)
```
...
ggsave("team_fg_vs_tp_scatter.png", plot = plot_scatter, width = 9, height = 6)
```